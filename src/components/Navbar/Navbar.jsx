  ...
  return (
    <header className="heading d-flex align-center">
      <h1 className="heading-1">
        ...
        <span class="material-symbols-outlined raven">
raven
</span>
          NestInn
        </Link>
      ...
      >
        <span className="form-option">{route === "home" ? "Choose your nest" : (destination || "Choose your nest")}</span>
      ...
      <nav className="d-flex align-center gap-large" onClick={handleAuthClick}>
        <div className="nav d-flex align-center cursor-pointer">
          ...
          <span className="material-symbols-outlined profile-option bird">
            flutter_dash
          </span>
        </div>
      </nav>
