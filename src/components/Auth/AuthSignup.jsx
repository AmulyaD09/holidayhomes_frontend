...
export const AuthSignup = () => {
  ...
  const handlePasswordChange = (event) => {
    ...
    if (isPasswordValid) {
      console.log("Valid Input");
      event.target.classList.remove("invalid-password");
      event.target.classList.add("valid-password");
      authDispatch({
        type: "PASSWORD",
        payload: event.target.value,
      });
      ...
      event.target.classList.remove("valid-password");
      event.target.classList.add("invalid-password");
    }
  };
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <div className="d-flex direction-column lb-in-container">
          ...
          <input
            ...
            className="auth-input"
            placeholder="Guard your nest with a mighty password!"
            type="password"
            required
